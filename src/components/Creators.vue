    ...
    <div class="flex flex-wrap -m-4 justify-center">
      <div class="lg:w-1/3 lg:mb-0 mb-6 p-4 mx-12">
        <div class="h-full text-center">
          ...
          <span class="inline-block h-1 w-10 rounded mt-6 mb-4" style="background-color: #297aa3"></span>
      ...
      <div class="lg:w-1/3 lg:mb-0 p-4 mx-12">
        <div class="h-full text-center">
          ...
          <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
          <span class="inline-block h-1 w-10 rounded mt-6 mb-4" style="background-color: #e95444"></span>
