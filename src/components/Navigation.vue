<template>
    ...
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <a class="mr-5 hover:text-gray-900">Reasons</a>
        <a class="mr-5 hover:text-gray-900">Interview</a>
        <a class="mr-5 hover:text-gray-900">Video</a>
        <a class="hover:text-gray-900">Articles</a>
        </nav>
